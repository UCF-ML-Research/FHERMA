...
int main(int argc, char *argv[])
{
    ...
    for (auto i = 1; i < argc; i += 2)
    {
     ...
     CIFAR10CKKS CIFAR10CKKS(ccLocation, pubKeyLocation, "../keys/secret-key.txt", multKeyLocation, rotKeyLocation, inputLocation, outputLocation, mode);
//    CIFAR10CKKS CIFAR10CKKS(ccLocation, pubKeyLocation, multKeyLocation, rotKeyLocation, inputLocation, outputLocation);
    CIFAR10CKKS.eval();
